...
assert tokenize('hello ') + [(TOKEN_TYPE_ARG, '1')] + tokenize(' world') == [(TOKEN_TYPE_TEXT, 'h'),(TOKEN_TYPE_TEXT, 'e'),(TOKEN_TYPE_TEXT, 'l'),(TOKEN_TYPE_TEXT, 'l'),(TOKEN_TYPE_TEXT, 'o'), (TOKEN_TYPE_SPACE, ' '), (TOKEN_TYPE_ARG, '1'), (TOKEN_TYPE_SPACE, ' '), (TOKEN_TYPE_TEXT, 'w'),(TOKEN_TYPE_TEXT, 'o'),(TOKEN_TYPE_TEXT, 'r'),(TOKEN_TYPE_TEXT, 'l'),(TOKEN_TYPE_TEXT, 'd')]
